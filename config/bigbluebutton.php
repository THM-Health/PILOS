...
$allowedFileMimes = array_values(array_filter(array_unique(explode(',', env('BBB_ALLOWED_FILE_MIMES', '')))));
...
return [
    ...
    'server_hashing_algorithm' => match (strtoupper(env('BBB_SERVER_HASHING_ALGORITHM', 'SHA1'))) {
