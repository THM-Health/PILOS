...
- **Client ID and client secret**: _Generated by the OpenID Connect Provider or set application URL_
- **Client secret**: _Generated by the OpenID Connect Provider or use a secure random string_
