  ...
  describe("Rooms view files file actions", function () {
    ...
    it("upload file", function () {
      ...
      cy.get('[data-test="room-files-upload-dialog"]')
        ...
        .within(() => {
          ...
          cy.get('[data-test="uploaded-file-message"]').should(
            "have.length",
            1,
          );
          ...
          cy.get('[data-test="uploaded-file-message"]')
            ...
            .should(
              "have.text",
              'rooms.files.uploaded_{"name":"testFile.txt"}',
            );
      ...
      cy.get('[data-test="room-files-upload-dialog"]')
        ...
        .within(() => {
          ...
          cy.get('[data-test="uploaded-file-message"]')
            ...
            .should(
              "have.text",
              'rooms.files.uploaded_{"name":"testFile2.txt"}',
            );
    ...
    it("change file settings errors", function () {
      ...
      cy.get('[data-test="room-files-edit-dialog"]')
        ...
        .and(
          "not.include.text",
          "The Use in the next meeting field is required.",
        )
    ...
    it.only("download file errors", function () {
      cy.fixture("config.json").then((config) => {
        config.data.room.file_terms_of_use = "Test terms of use";
