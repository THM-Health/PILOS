...
Cypress._.times(30, () => {
  describe("Rooms View access participant name", function () {
    ...
    it.only("rooms view with remembered participant name after logout (guest)", function () {
      cy.interceptRoomFilesRequest();
    ...
    it.only("change participant name (guest)", function () {
      cy.intercept("GET", "api/v1/currentUser", {});
      cy.interceptRoomFilesRequest();
          ...
          cy.get('[data-test="participant-name-field"]')
            ...
            .within(() => {
              ...
              cy.get("#participant-name")
                .should("be.visible")
                .and("have.value", "Laura Rivera");
              cy.contains("rooms.remember_participant_name").should(
                "be.visible",
              );
              cy.get("#remember-participant-name").and("not.be.checked");
            });
