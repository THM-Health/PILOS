  ...
  describe("Rooms view settings", function () {
    ...
    it("load settings", function () {
      ...
      cy.get('[data-test="access-code-setting"]')
        ...
        .within(() => {
          cy.get('[data-test="room-setting-enforced-icon"]').should(
            "not.exist",
          );
      ...
      cy.get('[data-test="welcome-setting"]')
        ...
        .should(
          "include.text",
          "rooms.settings.video_conference.welcome_message",
        )
        .should(
          "include.text",
    ...
    it("load settings with different permissions", function () {
      ...
      cy.get('[data-test="clear-access-code-button"]').should(
        "not.be.disabled",
      );
