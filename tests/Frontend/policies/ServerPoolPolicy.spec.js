...
describe('ServerPoolPolicy', () => {
  it(
    'viewAny returns true if the user has the permission to view any Server Pools',
    () => {
  ...
  it(
    'view returns true if the user has the permission to view server pool',
    () => {
  ...
  it(
    'update returns true if the user has the permission to update server pool',
    () => {
  ...
  it(
    'create returns true if the user has the permission to create server pool',
    () => {
  ...
  it(
    'delete returns true if the user has the permission to delete server pool',
    () => {
