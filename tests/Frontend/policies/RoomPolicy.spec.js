...
describe('RoomPolicy', () => {
  it(
    'viewAll returns returns if the user has the permission to view all rooms',
    () => {
  ...
  it(
    'create returns true if the user has the permission to create rooms',
    () => {
  ...
  it(
    'view invitation returns true if the user is the owner, co-owner, moderator or has the viewAll permission',
    () => {
  ...
  it(
    'delete returns true if the user is the owner or has mange room permission',
    () => {
  ...
  it(
    'viewSettings returns true if the user is the owner, co-owner or has view all room permission',
    () => {
  ...
  it(
    'manageSettings returns true if the user is the owner, co-owner or has manage room permission',
    () => {
  ...
  it(
    'becomeMember returns true if the room allows membership, user is not already member of the room and not the owner',
    () => {
