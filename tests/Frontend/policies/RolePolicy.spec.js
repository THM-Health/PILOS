...
describe('RolePolicy', () => {
  it(
    'viewAny returns true if the user has the permission to view all roles',
    () => {
  ...
  it(
    'view returns true if the user has the permission to view roles',
    () => {
  ...
  it(
    'create returns true if the user has the permission to create roles',
    () => {
  ...
  it(
    'update returns true if the user has the permission to update roles and the role is not a system default role',
    () => {
  ...
  it(
    'delete returns true if the user has the permission to delete roles and the role is not a system default role',
    () => {
