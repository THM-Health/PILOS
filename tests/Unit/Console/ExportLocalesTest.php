...
class ExportLocalesTest extends TestCase
{
    ...
    public function testExportLocales()
    {
        ...
        $this->assertEquals('{"app":{"key_1":"value_1","key_2":"value_2","key_3":{"key_3_1":"value_3_1","key_3_2":{"key_3_2_1":"value_3_2_1"}}}}', $fixturesDisk->get('en.json'));
        $this->assertEquals('{"app":{"key_1":"valeur_1"}}', $fixturesDisk->get('fr.json'));
    }
}
