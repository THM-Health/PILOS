...
Route::prefix('v1')->name('api.v1.')->group(function () {
    ...
    Route::post('password/email', [ForgotPasswordController::class,'sendResetLinkEmail'])->name('password.email')->middleware(['enable_if_config:auth.local.enabled', 'enable_if_setting:password_self_reset_enabled', 'guest', 'throttle:password_email']);
