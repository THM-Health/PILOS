export default {
  ...
  roomTypeInvalidAlert: 'The usage of the room type {roomTypeName} is only permitted for special user groups. To start the room, please change the room type, if you are the owner of this room.',
  flash: {
    noNewRoom: {
