  ...
  >
    <div class="overflow-y-auto" style="max-height:300px">
      ...
      <div v-if="currentSettings.expert_mode">
        ...
        <div class="field grid grid-cols-12 gap-4 mx-0">
          <span class="col-span-12 mb-2">{{ $t('rooms.settings.video_conference.lobby.title') }}</span>
          <!-- Current setting value -->
          ...
          <div class="col-span-2 fa-solid fa-arrow-right flex items-center justify-center"/>
          <!-- Resulting setting value -->
          <div class="col-span-3 flex justify-center items-center text-center">
        ...
        <div class="field grid grid-cols-12 gap-4 mx-0">
          <span class="col-span-12 mb-2">{{ $t('rooms.settings.participants.default_role.title') }} {{ $t('rooms.settings.participants.default_role.only_logged_in') }}</span>
          <!-- Current setting value -->
          <div class="col-span-3 flex justify-center items-center">
        ...
        <div class="field grid grid-cols-12 gap-4 mx-0">
          <span class="col-span-12 mb-2">{{ $t('rooms.settings.advanced.visibility.title') }}</span>
          <!-- Default setting -->
          <div class="col-span-3 flex justify-center items-center">
