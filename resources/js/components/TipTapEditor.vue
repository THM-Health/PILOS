...
function TipTapEditor(content, onUpdate) {
  return new Editor({
    ...
    editorProps: {
      attributes: {
        class:
          "prose prose-sm sm:prose-base lg:prose-lg xl:prose-2xl mt-2 p-2 focus:outline-primary focus:outline rounded-border border-surface border min-h-52 autofocus",
      },
    },
    onUpdate,
  });
