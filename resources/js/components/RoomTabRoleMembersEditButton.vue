<template>
  <Button
    v-tooltip="$t('rooms.members.role_members.edit')"
    data-test="room-role-members-edit-button"
    :aria-label="$t('rooms.members.role_members.edit')"
    :disabled="disabled"
    severity="info"
  ...
  <Dialog
    ...
    data-test="room-role-members-edit-dialog"
    modal
    :header="
      $t('rooms.members.role_members.modals.edit.title', {
        name: props.roleName,
      })
    "
    :style="{ width: '500px' }"
...
/**
 * show modal to edit role permission level
 */
function showModal() {
