...
export const HTTP_ROOM_GUESTS_NOT_ALLOWED = "guests_not_allowed";
export const HTTP_ROOM_GUESTS_ONLY = "guests_only";
export const HTTP_ROOM_FILE_FORBIDDEN = "forbidden";
export const HTTP_ROOM_FILE_NOT_FOUND = "file_not_found";
