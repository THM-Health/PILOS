  ...
  const can = (method, policy) => {
    if (import.meta.env.MODE !== "production") {
      ...
      if (
        ...
        (!Object.prototype.hasOwnProperty.call(policy, "model_name") ||
          typeof policy.model_name !== "string")
      ) {
        throw new ParameterMissingError(
          "The passed object for `policy` has no `model_name` or it is not of type string!",
        );
      }
    }
