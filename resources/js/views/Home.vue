<template>
  ...
  <div class="container pt-5 pb-5">
    <div class="row">
      <div class="col-md-12 col-sm-12 text-center">
        ...
        <p class="lead offset-lg-2 col-lg-8 col-sm-12 ">
          Die Grundlage dafür ist das auch in anderen Hochschulen zum Einsatz kommende Open Source Projekt <a
          href="https://bigbluebutton.org/" targent="_blank">BigBlueButton</a>.
        </p>
        <p class="lead offset-lg-2 col-lg-8 col-sm-12 ">
          Sie können für Ihre Veranstaltungen, Seminare und Übungen Räume erstellen und über einen praktischen Kurzlink
          Studenten, Mitarbeiter und Gäste einladen.
  ...
  <div class="container text-center">
    ...
    <h2 class="mb-4">Was PILOS alles kann</h2>
