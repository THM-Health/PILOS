    ...
    <OverlayComponent :show="isBusy || modelLoadingError">
      ...
      <form @submit.prevent="saveRoomType" class="flex flex-col gap-4">
            ...
            <div class="col-span-12 md:col-span-8">
              <InputGroup>
                <multiselect
                  ...
                  :allow-empty="false"
                  :class="{ 'is-invalid': formErrors.fieldInvalid('server_pool')}"
        ...
        <AdminPanel :title="$t('admin.room_types.default_room_settings.title')" >
          ...
          <h4 class="text-lg font-medium">{{ $t('rooms.settings.general.title') }}</h4>
          ...
          <h4 class="text-lg font-medium">{{ $t('rooms.settings.video_conference.title') }}</h4>
          ...
          <!-- Record settings -->
          <h4 class="text-lg font-medium">{{ $t('rooms.settings.recordings.title') }}</h4>
          ...
          <h4 class="text-lg font-medium">{{ $t('rooms.settings.restrictions.title') }}</h4>
          ...
          <h4 class="text-lg font-medium">{{ $t('rooms.settings.participants.title') }}</h4>
          ...
          <!-- Advanced settings -->
          <h4 class="text-lg font-medium">{{ $t('rooms.settings.advanced.title') }}</h4>
...
function saveRoomType () {
  ...
  api.call(props.id === 'new' ? 'roomTypes' : `roomTypes/${props.id}`, config).then(response => {
    formErrors.clear();
    router.push({ name: 'admin.room_types.view', params: { id: response.data.data.id } });
  }).catch(error => {
