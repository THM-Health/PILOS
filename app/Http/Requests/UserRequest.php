...
class UserRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'image' => ['bail', 'sometimes', 'nullable', File::types('jpg')->extensions('jpg')->max('20kb'), Rule::dimensions()->width(100)->height(100), Rule::prohibitedIf($this->user?->has_external_image), new Antivirus],
        ];
