...
class UserRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            ...
            'consent_to_presence_recording' => ['sometimes', 'required', 'boolean'],
            'consent_to_recording' => ['sometimes', 'required', 'boolean'],
            'consent_to_recording_image' => ['sometimes', 'required', 'boolean'],
