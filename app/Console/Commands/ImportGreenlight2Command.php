...
class ImportGreenlight2Command extends Command
{
     ...
     * @return array<int, int> Array map of greenlight user ids as key and id of the found/created user as value
     */
     ...
     * @param  array<int, int>  $userMap  Array map of greenlight user ids as key and id of the found/created user as value
     * @param  bool  $allowGuests  Are guests allowed to access the room
     * @param  string|null  $prefix  Prefix to add to room names
     * @return array<int, int> Array map of greenlight room ids as key and id of the created room as value
     */
     ...
     *
     * @param  array<int, int>  $roomMap  Array map of greenlight room ids as key and id of the created room as value
