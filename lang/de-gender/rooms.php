...
return [
    ...
    'bbb_error_message' => [
        'guestDeniedAccess' => 'Beitritt zur Besprechung fehlgeschlagen: Sie wurden aufgrund der Gastrichtlinie der Besprechung vom Beitritt zu dieser Besprechung ausgeschlossen.',
        'maxParticipantsReached' => 'Beitritt zur Besprechung fehlgeschlagen: Die für diese Besprechung zulässige Teilnehmerzahl wurde erreicht.',
        'meetingForciblyEnded' => 'Beitritt zur Besprechung fehlgeschlagen: Die Besprechung läuft nicht mehr.',
    ],
    ...
    'end_membership' => [
        ...
        'message' => 'Sie verlieren die Rolle, die mit Ihrer Mitgliedschaft verbunden ist. Um wieder Mitglied zu werden, müssen Sie eventuell den Raumeigentümer*in fragen. Wenn der Raum einen Zugangscode hat, müssen Sie diesen kennen, um weiterhin Zugang zu dem Raum zu haben.',
    ...
    'flash' => [
        ...
        'personalized_link_gone' => 'Der personalisierte Raumlink wurde inzwischen gelöscht.',
    ...
    'invitation' => [
        'code' => 'Zugangscode',
        'copied_code' => 'Zugangscode in die Zwischenablage kopiert',
        'copied_message' => 'Einladungsnachricht in die Zwischenablage kopiert',
        'copied_url' => 'Raumlink in die Zwischenablage kopiert',
        ...
        'share' => 'Teilen',
        'title' => 'Zugangsdaten für Teilnehmende',
    ],
    'join' => 'Beitreten',
    ...
    'members' => [
        'add_single_user' => 'Eine*n Benutzer*in hinzufügen',
        'add_user' => 'Benutzer*in hinzufügen',
        'bulk_edit_user' => ':numberOfSelectedUsers Mitglieder bearbeiten',
        'bulk_import_users' => 'Mehrere Benutzer*innen hinzufügen',
        'bulk_remove_user' => ':numberOfSelectedUsers Mitglieder löschen',
        'edit_user' => 'Mitglied bearbeiten',
        'filter' => [
            'all' => 'Alle',
            'co_owner_role' => 'Nur Mitbesitzende',
            'moderator_role' => 'Nur Moderierende',
            'participant_role' => 'Nur Teilnehmende',
        ],
        'image' => 'Bild',
        'modals' => [
            'add' => [
                ...
                'no_result' => 'Oops! Für diesen Suchbegriff konnten keine Benutzer*innen gefunden werden.',
                'placeholder' => 'Name oder Email',
                'select_role' => 'Bitte wählen Sie eine Rolle aus',
                'select_user' => 'Bitte wählen Sie eine*n Benutzer*in aus',
                'too_many_results' => 'Es wurden zu viele Benutzer*innen gefunden. Bitte geben Sie einen genaueren Suchbegriff ein.',
            ],
            'bulk_import' => [
                'can_import_users' => 'Benutzer*innen, die hinzugefügt werden können',
                'cannot_import_users' => 'Benutzer*innen, die nicht hinzugefügt werden können',
                'copied_invalid_users' => 'Ungültige Benutzer*innen wurden kopiert',
                'copy_and_close' => 'Ungültige Benutzer*innen kopieren und Schließen',
                'could_not_import_users' => 'Benutzer*innen, die nicht hinzugefügt werden konnten',
                'import_importable_button' => 'Gültige Benutzer*innen hinzufügen',
                'import_importable_question' => 'Möchten Sie fortfahren und die Benutzer*innen hinzufügen, die hinzugefügt werden können?',
                'imported_users' => 'Benutzer*innen, die erfolgreich hinzugefügt wurden',
                'label' => 'E-Mail-Liste',
    ...
    'only_used_by_authenticated_users' => 'Dieser Raum kann nur von angemeldeten Benutzer*innen verwendet werden.',
    'personalized_links' => [
    ...
    'recordings' => [
        ...
        'access_types' => [
            ...
            'moderator' => 'Mitgliedschaft: Moderierende',
            'owner' => 'Mitgliedschaft: Mitbesitzende',
            'participant' => 'Mitgliedschaft: Teilnehmende',
        ],
        'actions' => 'Aktionen',
        ...
        'filter' => [
            ...
            'moderator_access' => 'Zugriff: Moderierende',
            'owner_access' => 'Zugriff: Mitbesitzende',
            'participant_access' => 'Zugriff: Teilnehmende',
        ],
        'format_types' => [
            'notes' => 'Notizen',
    ...
    'role' => 'Rolle',
    'roles' => [
        'co_owner' => 'Mitbesitzend',
        'guest' => 'Gast',
        'moderator' => 'Moderierend',
        'no_role' => 'Keine Rolle',
    ...
    'settings' => [
        ...
        'participants' => [
            ...
            'default_role' => [
                'only_logged_in' => '(nur für angemeldete Benutzer*innen)',
                'title' => 'Standardrolle',
            ],
            'title' => 'Teilnehmer',
        ],
        'recordings' => [
            ...
            'record_attendance' => 'Anwesenheit der Teilnehmenden protokollieren',
        ...
        'restrictions' => [
            ...
            'lock_settings_hide_user_list' => 'Teilnehmendenliste verbergen',
            'title' => 'Teilnehmendenrechte in Videokonferenzen einschränken',
            'webcams_only_for_moderator' => 'Webcam nur für Moderierende sichtbar',
        ],
        'title' => 'Einstellungen',
        ...
        'video_conference' => [
            ...
            'lobby' => [
                'alert' => 'Standardrolle ist auf Moderierende gesetzt: Warteraum ist nur für Gäste und bereits bestehende Mitglieder mit Teilnehmerolle aktiv!',
