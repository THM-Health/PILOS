...
return [
    ...
    'errors' => [
        ...
        'role_delete_linked_users' => 'Die Rolle ist mit Benutzer*innen verknüpft und kann deshalb nicht gelöscht werden!',
        ...
        'room_type_invalid' => 'Die Art des Raumes ist für bestimmte Gruppen eingeschränkt. Wenn Sie Besitzer*in des Raumes sind, ändern Sie bitte die Raumart, damit der Raum gestartet werden kann.',
        ...
        'streaming_error' => 'Fehler beim Verbinden mit dem Streaming-Server. Bitte versuchen Sie es später erneut.',
        'streaming_meeting_not_running' => 'Das Meeting läuft nicht.',
    ...
    'flash' => [
        ...
        'guests_only' => 'Die Anfrage ist nur für nicht angemeldete Benutzer*innen gestattet!',
        'model_not_found' => [
            'details' => 'ID: :ids',
            'title' => 'Das :model wurde nicht gefunden!',
        ],
        'server_error' => [
    ...
    'model' => [
        ...
        'recording_format' => 'Aufnahmeformat',
        'role' => 'Rolle',
        'room' => 'Raum',
        'room_file' => 'Raumdatei',
        'room_personalized_link' => 'Personalisierter Link des Raumes',
        'room_type' => 'Raumarten',
        'server' => 'Server',
