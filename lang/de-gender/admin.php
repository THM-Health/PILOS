...
return [
    ...
    'roles' => [
        ...
        'permissions' => [
            ...
            'users' => [
                'create' => 'Benutzer*in erstellen',
                'delete' => 'Benutzer*in löschen',
                'title' => 'Benutzer*in',
                'update' => 'Benutzer*in bearbeiten',
                'update_own_attributes' => 'Eigenen Vornamen, Nachnamen und E-Mail bearbeiten',
                'view' => 'Benutzer*in anzeigen',
                'view_any' => 'Alle Benutzer*in anzeigen',
            ],
        ],
        ...
        'room_limit' => [
            ...
            'help_modal' => [
                'examples' => 'Beispiele',
                'info' => 'Die maximale Anzahl an eigenen Räumen ergibt sich aus dem Maximum der Begrenzungen der Rollen, denen die Benutzer*innen angehören.',
                'note' => 'X: Benutzer*in ist nicht Mitglied dieser Rolle',
                'role_a' => 'Rolle A',
                'role_b' => 'Rolle B',
        ...
        'superuser' => 'Superuser',
        'tile_description' => 'Die Rollen vergeben Berechtigungen, gliedern die Benutzer*innen und legen das Maximum an Räumen pro Benutzer*in fest.',
    ...
    'room_types' => [
        ...
        'max_participants' => 'Maximale Teilnehmendenzahl',
    ...
    'servers' => [
        ...
        'participant_count' => 'Teilnehmende',
        'reload' => 'Auslastung neu bestimmen',
        'secret' => 'API Geheimnis',
        'show_secret' => 'Klartext anzeigen',
        'status' => 'Status',
        'strength' => 'Serverstärke',
        'strength_description' => 'Faktor für Lastverteilung; je höher desto mehr Teilnehmende und Meetings kann der Server verarbeiten',
        'test_connection' => 'Verbindung testen',
        'tile_description' => 'Die Server stellen die BBB Infrastruktur für die Meetings bereit.',
        'unknown' => 'Unbekannt',
        'usage_info' => 'Die Auslastung (Meetings, Teilnehmende, Videos) beinhalten auch Meetings die von anderen Systemen verwaltet werden.',
        'version' => 'Version',
        'video_count' => 'Videos',
    ...
    'settings' => [
        ...
        'password_change_allowed' => 'Lokale Benutzer*in können Passwort ändern',
        'privacy_policy_url' => [
        ...
        'room_file_terms_of_use' => [
            'description' => 'Benutzer*innen müssen den Nutzungsbedingungen zustimmen, um Dateien herunterladen zu können. Wenn das Feld leer ist, ist keine Zustimmung erforderlich.',
        ...
        'room_limit' => [
            'description' => 'Begrenzt die Anzahl der Räume, die ein Benutzer*in haben kann. Diese Einstellung wird von den gruppenspezifischen Grenzen überschrieben.',
            'title' => 'Anzahl der Räume pro Benutzer*in',
        ],
        ...
        'theme' => [
            'custom_color' => 'Eigene Farbe',
            'custom_css' => 'Eigene CSS-Stildatei',
    ...
    'users' => [
        ...
        'bbb' => 'BigBlueButton',
        'delete' => [
            'confirm' => 'Wollen Sie den :firstname :lastname wirklich löschen?',
            'item' => 'Benutzer*in :firstname :lastname löschen',
            'title' => 'Benutzer*in löschen?',
        ],
        'edit' => 'Benutzer*in :firstname :lastname bearbeiten',
        'email' => 'E-Mail',
        'generate_password' => 'Passwort generieren lassen',
        'generate_password_description' => 'Es wird ein generiertes Passwort gesetzt und eine E-Mail mit einem Passwort-Rücksetz-Link versendet. Wird das Passwort innerhalb eines bestimmten Zeitraums nicht geändert, erfolgt die automatische Löschung des Kontos.',
        ...
        'new' => 'Neue*n Benutzer*in erstellen',
        'no_data' => 'Es sind keine Benutzer*innen vorhanden!',
        'no_data_filtered' => 'Für die Suchanfrage wurden keine Benutzer*innen gefunden!',
        ...
        'reset_password' => [
            ...
            'item' => 'Passwort für :firstname :lastname zurücksetzen',
        ...
        'tile_description' => 'Die Benutzer*innen können sich an dem System anmelden und je nach Rolle unterschiedliche Funktionen nutzen.',
        'timezone' => 'Zeitzone',
        'user_locale' => 'Sprache',
        'view' => 'Detaillierte Informationen für :firstname :lastname',
    ],
];
