...
return [
    'attendance' => [
        ...
        'sessions' => 'Sessions',
        'spreadsheet' => ['title' => 'Présence dans :room', 'worksheet' => 'Liste de présence'],
    ...
    'start' => 'Commencer',
    'stats' => ['amount' => 'Total', 'modal_title' => 'Statistiques d\'utilisation de :room', 'no_breakout_support' => 'L\'utilisation des salles de sous-groupe n\'est actuellement pas prise en charge. Seule l\'utilisation de la pièce principale est mesurée.', 'participants' => 'Participants', 'retention_period' => 'Les données d\'utilisations des salles sont conservées pendant :days jours.', 'retention_period_unlimited' => 'Les statistiques de salle sont sauvegardé indéfiniment.', 'time' => 'Durée', 'videos' => 'Caméras', 'voices' => 'Voix'],
