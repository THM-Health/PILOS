...
return [
    ...
    'custom' => [
        ...
        'consent_streaming' => [
            'accepted' => 'باید موافقت با استریمینگ ویدئو کنفرانس داده شود.',
        ],
        'default_pause_image' => [
            'dimensions' => 'مقدار :attribute باید وضوح 1920x1080 پیکسل داشته باشد.',
        ],
        ...
        'streaming_url' => [
            'required_if_accepted' => 'فیلد :attribute زمانی که استریمینگ فعال باشد، ضروری است.',
            'url' => 'مقدار :attribute باید یک URL از نوع RTMP یا RTMPS باشد.',
        ],
        'transfer_ownership' => [
